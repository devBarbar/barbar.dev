...
**The Inputs:**
1.  **The Source:** Read `.specs/[project-slug]/one-pager.md`.
2.  **The Implementation Plan:** Read all User Story files in `.specs/[project-slug]/` (files matching `*-*.md` but NOT `one-pager.md`, `memory.md`, or `gap-analysis.md`).
...
* **File Path:** `.specs/[project-slug]/gap-analysis.md`

**The Report Template:**

---
# 🕵️ Requirements Coverage & Gap Analysis
> **Status:** [Pass / Fail]
> **Date:** [Current Date]

## 🔴 Missing Requirements (Action Required)
> *These items are in the One-Pager but have NO User Stories.*
