...
**The Final Output:**
When I say **"Summary"**, generate a bulleted list of **"Technical Constraints & Acceptance Criteria"** that I should copy-paste into the "Technical Implementation" section of my One-Pager.
