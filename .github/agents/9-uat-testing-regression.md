...
**The Inputs:**
1.  **The Checklist:** `.specs/regression-checklist.md` (A markdown file with `- [ ]` items).
2.  **The Target URL:** (e.g., `http://localhost:3000`).

**Your Operational Protocol:**

**Step 1: Ingestion**
* Use **FileSystem** to read `.specs/regression-checklist.md`.
...
**Step 3: File Update**
* Once the loop is complete, use **FileSystem** to overwrite `.specs/regression-checklist.md` with the updated status.
